...
parser = argparse.ArgumentParser(description='EEHRS')
...
parser.add_argument('--data_dir', type=str, default=os.path.join(os.path.dirname(os.path.dirname(__file__)), 'data', 'NELL23K'),
...
parser.add_argument('--relation_only', action='store_true', default=False,
                    help='search with relation information only, ignoring entity representation (default: False)')
parser.add_argument('--relation_only_in_path', action='store_true', default=False,
                    help='include intermediate entities in path (default: False)')
parser.add_argument('--relation_path_true', action='store_true', default=False,
                    help='relation true in path (default: False)')
...
parser.add_argument('--conve_state_dict_path', type=str, default='../model/NELL23K-conve-RV-xavier-200-200-0.003-32-3-0.3-0.3-0.2-0.1/model_best.tar',
...
parser.add_argument('--bandwidth', type=int, default=200,
...
parser.add_argument('--save_beam_search_paths', action='store_true', default=True,
...
# HRL
parser.add_argument('--rl_module', type=str, default='hrl',
                    help='original: REINFORCE; hrl: hierarchical REINFORCE', choices=['original', 'hrl'])
parser.add_argument('--hrl_ff_dropout', action="store_true", default=True,
                    help='whether to dropout relation and tailentity, 1 for dropout and otherwise')
parser.add_argument('--hff_dropout_rate', type=float, default=0.1,
                    help='Feed-forward layer dropout rate (default: 0.1)')
parser.add_argument('--lff_dropout_rate', type=float, default=0.1,
                    help='Feed-forward layer dropout rate (default: 0.1)')
parser.add_argument('--aff_dropout_rate', type=float, default=0.1,
                    help='Feed-forward layer dropout rate (default: 0.1)')
parser.add_argument('--relation_dropout_rate', type=float, default=0.2)
parser.add_argument('--tailentity_dropout_rate', type=float, default=0.3)
parser.add_argument('--use_relation_tailentity_space_bucketing', action='store_true', default=True)
parser.add_argument('--relation_bucket_interval', type=int, default=10,
                    help='adjacency list bucket size (default: 32)')
parser.add_argument('--tailentity_bucket_interval', type=int, default=10,
                    help='adjacency list bucket size (default: 32)')

parser.add_argument('--beam_size_high', type=int, default=8,
                    help='size of beam used in beam search inference (default: 100)')
parser.add_argument('--beam_size_low', type=int, default=64)

parser.add_argument('--high_embedding_num', type=int, default=4)
parser.add_argument('--low_embedding_num', type=int, default=3)
...
parser.add_argument('--add_tailentity_space', action="store_true", default=True,
                    help="set add tailentity space")
parser.add_argument('--additional_tailentity_size', type=int, default=40, choices=[5, 10, 20, 30, 40])

parser.add_argument('--set_high_reward', action="store_true", default=True,
                    help="set high reward")
