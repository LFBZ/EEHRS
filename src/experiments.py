...
def initialize_model_directory(args, random_seed=None):
    ...
    if args.model in ['rule']:
        ...
        if args.action_dropout_anneal_interval < 1000:
            ...
            # mechanism signature
            set_embedding = "EE" if args.set_embedding else ""
            add_tailentity_space = "ASC" if args.add_tailentity_space else ""
            set_high_reward = "HRS" if args.set_high_reward else ""
            other_option = set_embedding + add_tailentity_space + str(args.additional_tailentity_size) + set_high_reward
            hyperparam_sig = '{}-{}-{}-{}-{}-{}-{}-{}-{}-{}-{}-{}-{}-{}-{}-{}'.format(
                args.baseline,
                args.rl_module,
                args.entity_dim,
                ...
                args.ff_dropout_rate,
                args.action_dropout_rate,
                args.hff_dropout_rate,
                args.lff_dropout_rate,
